...
contextBridge.exposeInMainWorld("workbench", {
  ...
  rewindConversation: (input: RewindConversationInput): Promise<WorkbenchResponse<RewindConversationResult>> => ipcRenderer.invoke("workbench:rewind-conversation", input),
  restoreConversationRevision: (input: RestoreConversationRevisionInput): Promise<WorkbenchResponse<WorkbenchState>> => ipcRenderer.invoke("workbench:restore-conversation-revision", input),

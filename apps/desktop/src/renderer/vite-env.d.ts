...
interface WorkbenchBridge {
  ...
  readAgentThread: (input: AgentThreadReplayInput) => Promise<WorkbenchResponse<AgentThreadSnapshot | null>>;
  ...
  discoverCapabilitySkills: (input: DiscoverCapabilitySkillsInput) => Promise<WorkbenchResponse<CapabilitySkillDiscoveryReport>>;
  importDiscoveredCapabilitySkills: (input: ImportDiscoveredCapabilitySkillsInput) => Promise<WorkbenchResponse<CapabilityCenterSnapshot>>;
  ...
  rewindConversation: (input: RewindConversationInput) => Promise<WorkbenchResponse<RewindConversationResult>>;
  restoreConversationRevision: (input: RestoreConversationRevisionInput) => Promise<WorkbenchResponse<WorkbenchState>>;
  ...
  importCaseAttachments: (input: ImportCaseAttachmentsInput) => Promise<WorkbenchResponse<CaseAttachmentImportResult>>;
  exportCaseDiagram: (input: ExportCaseDiagramInput) => Promise<WorkbenchResponse<ExportCaseDiagramResult>>;

...
| 配置中心 | [02-config-center.png](images/02-config-center.png) | 当前项目的 ADT、飞书 CLI、API 模型、可选本机增强和本地存储等配置与验证。Codex 不是核心依赖。 |
...
| [../architecture/INDEPENDENT_AGENT_RUNTIME.md](../architecture/INDEPENDENT_AGENT_RUNTIME.md) | Phase 50 起的独立 Agent Runtime 架构，定义工具、上下文、记忆、Skill、MCP 和子 Agent。 |
